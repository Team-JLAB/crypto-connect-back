# Generated by Django 3.2.2 on 2021-05-10 00:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Wallet',
            fields=[
                ('user_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='crypto_api.user')),
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('10000'), default_currency='USD', max_digits=14)),
            ],
        ),
        migrations.CreateModel(
            name='Watchlist',
